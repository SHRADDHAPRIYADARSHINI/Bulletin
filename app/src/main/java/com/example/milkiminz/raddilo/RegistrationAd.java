...
public class RegistrationAd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_ad);
        name = (EditText) findViewById(R.id.spname);
        company = (EditText) findViewById(R.id.acomname) ;
        ...
        loginUrl = getResources().getString(R.string.registerad);
        ...
        if (!name.getText().toString().equals("") || !email.getText().toString().equals("") || !password.getText().toString().equals("") || !phone.getText().toString().equals("") || !address.getText().toString().equals("")) {
            if (isNetworkAvailable()) {
                if (password.getText().toString().equals(confirmpassword.getText().toString())) {
                    ...
                    Toast.makeText(RegistrationAd.this, getResources().getString(R.string.differentpassword), Toast.LENGTH_SHORT).show();
                }
            } else
    ...
    public void login(View view) {
        startActivity(new Intent(RegistrationAd.this, LoginAd.class));
    }
    ...
    class AttemptRegister extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(RegistrationAd.this);
        ...
        protected String doInBackground(String... args) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, loginUrl,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String s) {
                            ...
                            if (s.equals(getResources().getString(R.string.success))) {
                                ...
                                saveData2(em);
                                Toast.makeText(RegistrationAd.this, getResources().getString(R.string.successfullyregistered), Toast.LENGTH_LONG).show();
                                startActivity(new Intent(RegistrationAd.this,OtpAd.class));
                                finish();
                            } else if (s.equals(getResources().getString(R.string.failed))) {


                                Toast.makeText(RegistrationAd.this, getResources().getString(R.string.rf), Toast.LENGTH_LONG).show();

                            } else if (s.equals(getResources().getString(R.string.already))) {
                                Toast.makeText(RegistrationAd.this, getResources().getString(R.string.ar), Toast.LENGTH_LONG).show();
                ...
                public void onErrorResponse(VolleyError volleyError) {
                    ...
                    Toast.makeText(RegistrationAd.this, volleyError.getMessage(), Toast.LENGTH_LONG).show();
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("aphone", ph);
                    params.put("company",com);
                    params.put("aaddress", add);
            ...
            requestQueue = Volley.newRequestQueue(RegistrationAd.this);
