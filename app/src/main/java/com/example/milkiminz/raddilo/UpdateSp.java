...
public class UpdateSp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue = Volley.newRequestQueue(UpdateSp.this);
    }
    public void update1(View view) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://139.59.47.63/updatespprofile.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                if (response.equals(getResources().getString(R.string.success))) {
                    Toast.makeText(UpdateSp.this, getResources().getString(R.string.successfullyupdated), Toast.LENGTH_LONG).show();
                    startActivity(new Intent(UpdateSp.this, ProfileSp.class));
                    finish();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(UpdateSp.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
