...
public class UpdateAd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue = Volley.newRequestQueue(UpdateAd.this);
    }
    public void update1(View view) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://139.59.47.63/updateadprofile.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                if (response.equals(getResources().getString(R.string.success))) {
                    Toast.makeText(UpdateAd.this, getResources().getString(R.string.successfullyupdated), Toast.LENGTH_LONG).show();
                    startActivity(new Intent(UpdateAd.this, ProfileAd.class));
                    finish();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(UpdateAd.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
